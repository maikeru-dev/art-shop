...
$thingy = "INSERT INTO art_items (name, date_of_completion, width, height, price, description) VALUES
...
('Las Meninas', 1656, 318.00, 276.00, 400000000.00, 'Diego Velázquez''s complex and dynamic portrayal of the Spanish royal family and their attendants.'),('Bal du moulin de la Galette', 1876, 131.00, 175.00, 78000000.00, 'Pierre-Auguste Renoir''s lively depiction of a Parisian dance hall filled with joyful figures.'),
...
if (isset($dbConn)) {
  $dbConn->query($thingy);
  echo 'Added all the stuff! Run this only once!';
}else {
  echo 'dbConn does not exist!';
}
